...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7697970661807329)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7698260786807329)
,p_plug_template_id=>wwv_flow_imp.id(7697970661807329)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7698515883807328)
,p_plug_template_id=>wwv_flow_imp.id(7697970661807329)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7698861869807328)
,p_plug_template_id=>wwv_flow_imp.id(7697970661807329)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7699127514807328)
,p_plug_template_id=>wwv_flow_imp.id(7697970661807329)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7699462174807328)
,p_plug_template_id=>wwv_flow_imp.id(7697970661807329)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
