...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7713570316807312)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7713876873807311)
,p_plug_template_id=>wwv_flow_imp.id(7713570316807312)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7714101081807311)
,p_plug_template_id=>wwv_flow_imp.id(7713570316807312)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7714490642807311)
,p_plug_template_id=>wwv_flow_imp.id(7713570316807312)
,p_name=>'Button Start'
