...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7805961664807133)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7806269229807129)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7806582399807128)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7806862328807128)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7807145392807128)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7807484652807127)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7807715931807127)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7808032954807127)
,p_plugin_attribute_id=>wwv_flow_imp.id(7807715931807127)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7808451519807126)
,p_plugin_attribute_id=>wwv_flow_imp.id(7807715931807127)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7808883085807125)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7809146367807125)
,p_plugin_attribute_id=>wwv_flow_imp.id(7808883085807125)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7809500069807124)
,p_plugin_attribute_id=>wwv_flow_imp.id(7808883085807125)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7809997047807124)
,p_plugin_attribute_id=>wwv_flow_imp.id(7808883085807125)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7810332227807124)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7810631124807124)
,p_plugin_attribute_id=>wwv_flow_imp.id(7810332227807124)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7811004829807123)
,p_plugin_attribute_id=>wwv_flow_imp.id(7810332227807124)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7811488010807123)
,p_plugin_attribute_id=>wwv_flow_imp.id(7810332227807124)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1519288227172909318)
,p_plugin_id=>wwv_flow_imp.id(7805961664807133)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
