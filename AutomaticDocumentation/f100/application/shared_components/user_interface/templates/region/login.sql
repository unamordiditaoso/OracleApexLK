...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7716005874807310)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7716359161807310)
,p_plug_template_id=>wwv_flow_imp.id(7716005874807310)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7716635710807310)
,p_plug_template_id=>wwv_flow_imp.id(7716005874807310)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7716900497807309)
,p_plug_template_id=>wwv_flow_imp.id(7716005874807310)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7717264245807309)
,p_plug_template_id=>wwv_flow_imp.id(7716005874807310)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7717513435807309)
,p_plug_template_id=>wwv_flow_imp.id(7716005874807310)
,p_name=>'Sub Regions'
