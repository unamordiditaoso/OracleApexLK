...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7814762676807113)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807833113875690754)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807832558863690753)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7815401317807103)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7815725302807103)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7816069812807102)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7816382235807102)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7816668233807101)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7816069812807102)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1807833113875690754)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7816911940807101)
,p_plugin_attribute_id=>wwv_flow_imp.id(7816668233807101)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7817354074807101)
,p_plugin_attribute_id=>wwv_flow_imp.id(7816668233807101)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7817709494807100)
,p_plugin_attribute_id=>wwv_flow_imp.id(7816668233807101)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7818169607807100)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7816668233807101)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7818444278807099)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7818768946807099)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7819040703807099)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7819392250807098)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7819687225807098)
,p_plugin_attribute_id=>wwv_flow_imp.id(7819392250807098)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7820046764807098)
,p_plugin_attribute_id=>wwv_flow_imp.id(7819392250807098)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7820442450807097)
,p_plugin_attribute_id=>wwv_flow_imp.id(7819392250807098)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7820853866807096)
,p_plugin_attribute_id=>wwv_flow_imp.id(7819392250807098)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7821224855807096)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(7816382235807102)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1807832558863690753)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7821572138807095)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7821817525807095)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7822154567807094)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7822467666807094)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7822753125807093)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7823016457807093)
,p_plugin_attribute_id=>wwv_flow_imp.id(7822753125807093)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7823431382807093)
,p_plugin_attribute_id=>wwv_flow_imp.id(7822753125807093)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7823868189807092)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7824171460807092)
,p_plugin_attribute_id=>wwv_flow_imp.id(7823868189807092)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7824521752807091)
,p_plugin_attribute_id=>wwv_flow_imp.id(7823868189807092)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7824943424807091)
,p_plugin_attribute_id=>wwv_flow_imp.id(7823868189807092)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7825373537807090)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7825627485807090)
,p_plugin_attribute_id=>wwv_flow_imp.id(7825373537807090)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7826028549807090)
,p_plugin_attribute_id=>wwv_flow_imp.id(7825373537807090)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7826480209807089)
,p_plugin_attribute_id=>wwv_flow_imp.id(7825373537807090)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7826882965807089)
,p_plugin_attribute_id=>wwv_flow_imp.id(7825373537807090)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7827258390807088)
,p_plugin_attribute_id=>wwv_flow_imp.id(7825373537807090)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7827697518807088)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7827923196807087)
,p_plugin_attribute_id=>wwv_flow_imp.id(7827697518807088)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7828363082807087)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808036166032837382)
,p_plugin_id=>wwv_flow_imp.id(7814762676807113)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
