...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7667501312807354)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7667865145807354)
,p_plug_template_id=>wwv_flow_imp.id(7667501312807354)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7668190798807354)
,p_plug_template_id=>wwv_flow_imp.id(7667501312807354)
,p_name=>'Sub Regions'
