...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7856549887807029)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935094379073878719)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935093824061878718)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1678201760331605205)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7857420578807023)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7857753420807022)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7858070107807021)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7858303721807021)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7858607970807021)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7858992690807020)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7859284850807019)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7858607970807021)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1935094379073878719)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7859507772807019)
,p_plugin_attribute_id=>wwv_flow_imp.id(7859284850807019)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7859931248807018)
,p_plugin_attribute_id=>wwv_flow_imp.id(7859284850807019)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7860304053807018)
,p_plugin_attribute_id=>wwv_flow_imp.id(7859284850807019)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7860795864807017)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7859284850807019)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7861077747807017)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7861377152807016)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7861679141807016)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7861973078807015)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7862254874807014)
,p_plugin_attribute_id=>wwv_flow_imp.id(7861973078807015)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7862629901807014)
,p_plugin_attribute_id=>wwv_flow_imp.id(7861973078807015)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7863081505807013)
,p_plugin_attribute_id=>wwv_flow_imp.id(7861973078807015)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7863457917807013)
,p_plugin_attribute_id=>wwv_flow_imp.id(7861973078807015)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7863871031807012)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(7858992690807020)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1935093824061878718)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7864133887807011)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7864433830807011)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7864791928807011)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7865060745807010)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7865344646807010)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7865657241807009)
,p_plugin_attribute_id=>wwv_flow_imp.id(7865344646807010)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7866072679807009)
,p_plugin_attribute_id=>wwv_flow_imp.id(7865344646807010)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7866472689807008)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7866783943807007)
,p_plugin_attribute_id=>wwv_flow_imp.id(7866472689807008)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7867115414807007)
,p_plugin_attribute_id=>wwv_flow_imp.id(7866472689807008)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7867548438807006)
,p_plugin_attribute_id=>wwv_flow_imp.id(7866472689807008)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7867964416807006)
,p_plugin_attribute_id=>wwv_flow_imp.id(7866472689807008)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7868340146807005)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7868614946807005)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7869077263807004)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7869468163807004)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7869817201807003)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7870291620807003)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7870656058807002)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7871037247807002)
,p_plugin_attribute_id=>wwv_flow_imp.id(7868340146807005)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7871428559807002)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7871778491807001)
,p_plugin_attribute_id=>wwv_flow_imp.id(7871428559807002)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7872107141807000)
,p_plugin_attribute_id=>wwv_flow_imp.id(7871428559807002)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7872542938807000)
,p_plugin_attribute_id=>wwv_flow_imp.id(7871428559807002)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7872918628806999)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7873269640806999)
,p_plugin_attribute_id=>wwv_flow_imp.id(7872918628806999)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7873648506806999)
,p_plugin_attribute_id=>wwv_flow_imp.id(7872918628806999)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7874083052806998)
,p_plugin_attribute_id=>wwv_flow_imp.id(7872918628806999)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7874479917806997)
,p_plugin_attribute_id=>wwv_flow_imp.id(7872918628806999)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7874802019806997)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7875145630806996)
,p_plugin_attribute_id=>wwv_flow_imp.id(7874802019806997)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7875518205806996)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7875820235806996)
,p_plugin_attribute_id=>wwv_flow_imp.id(7875518205806996)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7876207389806995)
,p_plugin_attribute_id=>wwv_flow_imp.id(7875518205806996)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7876605322806995)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7876903777806994)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7877291410806992)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1678201760331605205)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7877518099806992)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7877865519806991)
,p_plugin_attribute_id=>wwv_flow_imp.id(7877518099806992)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7878246958806990)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7878513594806990)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816308269289700333)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816309528809704481)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1519356754393941903)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1802714640615293600)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803393941345376704)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816306334222655347)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816307667612669204)
,p_plugin_id=>wwv_flow_imp.id(7856549887807029)
