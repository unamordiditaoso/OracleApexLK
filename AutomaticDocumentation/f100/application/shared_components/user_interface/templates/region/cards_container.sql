...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7681666283807342)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7681970290807342)
,p_plug_template_id=>wwv_flow_imp.id(7681666283807342)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7682261969807342)
,p_plug_template_id=>wwv_flow_imp.id(7681666283807342)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7682545240807342)
,p_plug_template_id=>wwv_flow_imp.id(7681666283807342)
,p_name=>'Sub Regions'
