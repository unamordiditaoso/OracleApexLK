...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7731053890807300)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7731372562807300)
,p_plug_template_id=>wwv_flow_imp.id(7731053890807300)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7731619779807300)
,p_plug_template_id=>wwv_flow_imp.id(7731053890807300)
,p_name=>'Tabs'
