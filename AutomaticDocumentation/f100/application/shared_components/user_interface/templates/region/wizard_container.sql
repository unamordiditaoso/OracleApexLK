...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7738711554807296)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7739076949807296)
,p_plug_template_id=>wwv_flow_imp.id(7738711554807296)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7739305525807295)
,p_plug_template_id=>wwv_flow_imp.id(7738711554807296)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7739654731807295)
,p_plug_template_id=>wwv_flow_imp.id(7738711554807296)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7739966172807295)
,p_plug_template_id=>wwv_flow_imp.id(7738711554807296)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7740207144807295)
,p_plug_template_id=>wwv_flow_imp.id(7738711554807296)
