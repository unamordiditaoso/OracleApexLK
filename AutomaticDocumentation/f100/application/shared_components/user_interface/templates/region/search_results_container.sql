...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7718593514807308)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7718861012807308)
,p_plug_template_id=>wwv_flow_imp.id(7718593514807308)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7719190482807308)
,p_plug_template_id=>wwv_flow_imp.id(7718593514807308)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7719495445807308)
,p_plug_template_id=>wwv_flow_imp.id(7718593514807308)
,p_name=>'Sub Regions'
