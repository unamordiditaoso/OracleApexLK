...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7796805175807204)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7797190550807171)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7797445612807165)
,p_plugin_attribute_id=>wwv_flow_imp.id(7797190550807171)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7797819600807163)
,p_plugin_attribute_id=>wwv_flow_imp.id(7797190550807171)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7798287899807162)
,p_plugin_attribute_id=>wwv_flow_imp.id(7797190550807171)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7798665029807161)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7797190550807171)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7798979254807159)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7799296654807159)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7799599064807159)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7799891132807157)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7800183264807156)
,p_plugin_attribute_id=>wwv_flow_imp.id(7799891132807157)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7800529707807156)
,p_plugin_attribute_id=>wwv_flow_imp.id(7799891132807157)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7800978796807156)
,p_plugin_attribute_id=>wwv_flow_imp.id(7799891132807157)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7801384783807155)
,p_plugin_attribute_id=>wwv_flow_imp.id(7799891132807157)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7801783138807155)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7802028369807154)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7802465193807154)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7802889677807153)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7803203465807153)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7803616783807152)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7804066436807152)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7804478885807151)
,p_plugin_attribute_id=>wwv_flow_imp.id(7801783138807155)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7804873276807151)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1807847686748920941)
,p_plugin_id=>wwv_flow_imp.id(7796805175807204)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
