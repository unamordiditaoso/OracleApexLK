...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7654637498807363)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7654958074807363)
,p_plug_template_id=>wwv_flow_imp.id(7654637498807363)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7655232340807363)
,p_plug_template_id=>wwv_flow_imp.id(7654637498807363)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7655543052807363)
,p_plug_template_id=>wwv_flow_imp.id(7654637498807363)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7655871902807362)
,p_plug_template_id=>wwv_flow_imp.id(7654637498807363)
,p_name=>'Sub Regions'
