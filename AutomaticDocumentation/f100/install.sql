...
@@workspace/remote_servers/pokeapi_co_api_v2.sql
@@application/shared_components/data_profiles/pokemon_prueba.sql
@@application/shared_components/web_sources/pokemon_prueba.sql
...
@@application/shared_components/user_interface/lovs/cliente_nombre.sql
