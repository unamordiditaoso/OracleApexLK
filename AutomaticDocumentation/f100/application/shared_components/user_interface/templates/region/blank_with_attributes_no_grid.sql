...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7656034908807362)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7656303877807362)
,p_plug_template_id=>wwv_flow_imp.id(7656034908807362)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7656685104807362)
,p_plug_template_id=>wwv_flow_imp.id(7656034908807362)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7656993880807362)
,p_plug_template_id=>wwv_flow_imp.id(7656034908807362)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7657233713807362)
,p_plug_template_id=>wwv_flow_imp.id(7656034908807362)
,p_name=>'Sub Regions'
