...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7683593304807341)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7683858396807341)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7684113427807340)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7684413419807340)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7684733743807340)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7685026821807340)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7685344894807340)
,p_plug_template_id=>wwv_flow_imp.id(7683593304807341)
,p_name=>'Sub Regions'
