...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7711466006807313)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7711732312807313)
,p_plug_template_id=>wwv_flow_imp.id(7711466006807313)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7712008591807312)
,p_plug_template_id=>wwv_flow_imp.id(7711466006807313)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7712345613807312)
,p_plug_template_id=>wwv_flow_imp.id(7711466006807313)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7712630358807312)
,p_plug_template_id=>wwv_flow_imp.id(7711466006807313)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7712905217807312)
,p_plug_template_id=>wwv_flow_imp.id(7711466006807313)
,p_name=>'Sub Regions'
